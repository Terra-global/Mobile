    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scroll}>
        <View style={styles.header}>
          ...
          <Text style={styles.description}>Plant & Crop specific thermal data</Text>
        </View>
        ...
        <View style={styles.formCard}>
          ...
          <TouchableOpacity style={styles.button} onPress={handleAnalyze} disabled={loading}>
            {loading ? <ActivityIndicator color="#1e2126" /> : <Text style={styles.buttonText}>Analyze {cropName}</Text>}
          </TouchableOpacity>
        </View>
            ...
            {data.aiAdvice && (
              <View style={styles.adviceCard}>
                <View style={styles.adviceHeader}>
                  <Ionicons name="sparkles" size={20} color="#c1ff72" />
                  <Text style={styles.adviceTitle}>Agri-Oracle Advisory</Text>
                </View>
