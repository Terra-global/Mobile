      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        <View style={[styles.formCard, { backgroundColor: themeColors.card, borderColor: themeColors.border }]}>
          ...
          <View style={styles.toggleRow}>
            <View style={styles.toggleTextContainer}>
              ...
              <Text style={[styles.toggleSub, { color: themeColors.subtext }]}>Set custom coordinates for analysis</Text>
            </View>
            <Switch
              value={useManualLoc}
          ...
          <TouchableOpacity 
            ...
            activeOpacity={0.8}
          >
            {loading ? <ActivityIndicator color="#fff" /> : <Text style={styles.buttonText}>Run Diagnostics</Text>}
          </TouchableOpacity>
        </View>
        ...
        {data && (
          <View style={styles.resultsContainer}>
              ...
              <View style={[styles.adviceCard, { backgroundColor: themeColors.card, borderColor: themeColors.tint + '40' }]}>
                <View style={styles.adviceHeader}>
                  <View style={[styles.iconCircle, { backgroundColor: themeColors.tint + '20' }]}>
                    <Ionicons name="medical" size={20} color={themeColors.tint} />
                  </View>
                  <View>
                    <Text style={[styles.adviceTitle, { color: themeColors.text }]}>Veterinary Insight</Text>
            ...
            >
              <Text style={[styles.debugText, { color: themeColors.subtext }]}>View Full Data Sheet</Text>
